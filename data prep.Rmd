...
-will select by "Count" = Minutes 
- ? use other surface & air met data for 1 hr during the event? [is air temp only taken twice/dy, thus won't matter?]

```{r}
# june 
#Min_24 <- data.frame(Year=2016, Month=06, Day=10, Hour=11,  Count=seq(1:24))

#Min_24 <- data.frame(Year=2016, Month=06, Day=10, Hour=seq(1:24))

AAS1 <- subset(met, Day==10 & Hour ==11 & Minute >=1 & Minute <=7)
##copy for later
#AAS1b <- AAS1
#AAS1$Count <- seq(1:length(AAS1$Minute))
#AAS1 <- merge(Min_24, AAS1, by=c("Year", "Month", "Day", "Hour"), all.x = T)

#write.csv(AAS1, "/Users/magaliblanco/Everything/School/PhD_UW/Courses/2. Winter 18/ENVH 595 Yost RR/Data/Dylos/Event Min Met/AAS1.csv", row.names=F)


## example of 1 set of met readings/event
## replace 1st minute values w/ spray period avg
# AAS1b <- AAS1
# AAS1b[AAS1b$Minute==1 & !is.na(AAS1b$Minute), "Temp_C_3m"] <- round(mean(AAS1b$Temp_C_3m, na.rm = T),1)

AAS1_event <- AAS1
AAS1_event <- aggregate(data=AAS1_event, .~ Year + Month + Day + Hour, mean)
AAS1_event$Temp_C_3m <- round(AAS1_event$Temp_C_3m,1)
AAS1_event$Temp_C_10m <- round(AAS1_event$Temp_C_10m,1)
AAS1_event$rh <- round(AAS1_event$rh)
AAS1_event$WD_Deg <- round(AAS1_event$WD_Deg)
AAS1_event$WS_ms <- round(AAS1_event$WS_ms, 1)

#colnames(AAS1_event)[colnames(AAS1_event)=="Minute"] <- "Count"
#AAS1_event$Count <- 11
Count_24 <- data.frame(Year=2016, Month=06, Day=10, Hour=seq(1:24)) 
AAS1_event <- merge(Count_24, AAS1_event, by=c("Year", "Month", "Day", "Hour"), all.x=T)

 AAS1_event <- AAS1_event[c("Year", "Month", "Day", "Count", "Temp_C_10m", "rh", "WD_Deg", "WS_ms")]

 #add missing indicators
 AAS1_event[is.na(AAS1_event$Temp_C_10m), "Temp_C_10m"] <- 99
 AAS1_event[is.na(AAS1_event$rh), "rh"] <- 999
 AAS1_event[is.na(AAS1_event$WD_Deg), "WD_Deg"] <- 999
 AAS1_event[is.na(AAS1_event$WS_ms), "WS_ms"] <- 99
 
#write.table(AAS1_event, "/Users/magaliblanco/Everything/School/PhD_UW/Courses/2. Winter 18/ENVH 595 Yost RR/Data/Dylos/Event Min Met/AAS1_event.txt", row.names=F, col.names=F)
...
#write.csv(AAS2, "/Users/magaliblanco/Everything/School/PhD_UW/Courses/2. Winter 18/ENVH 595 Yost RR/Data/Dylos/Event Min Met/AAS2.csv", row.names=F)
...
#write.csv(AAS3, "/Users/magaliblanco/Everything/School/PhD_UW/Courses/2. Winter 18/ENVH 595 Yost RR/Data/Dylos/Event Min Met/AAS3.csv", row.names=F)
...
#write.csv(AAS4, "/Users/magaliblanco/Everything/School/PhD_UW/Courses/2. Winter 18/ENVH 595 Yost RR/Data/Dylos/Event Min Met/AAS4.csv", row.names=F)
...
#write.csv(AAS5, "/Users/magaliblanco/Everything/School/PhD_UW/Courses/2. Winter 18/ENVH 595 Yost RR/Data/Dylos/Event Min Met/AAS5.csv", row.names=F)
...
#write.csv(AAS6, "/Users/magaliblanco/Everything/School/PhD_UW/Courses/2. Winter 18/ENVH 595 Yost RR/Data/Dylos/Event Min Met/AAS6.csv", row.names=F)
...
#write.csv(AAS7, "/Users/magaliblanco/Everything/School/PhD_UW/Courses/2. Winter 18/ENVH 595 Yost RR/Data/Dylos/Event Min Met/AAS7.csv", row.names=F)
...
#write.csv(AAS8, "/Users/magaliblanco/Everything/School/PhD_UW/Courses/2. Winter 18/ENVH 595 Yost RR/Data/Dylos/Event Min Met/AAS8.csv", row.names=F)
...
#write.csv(AAS9, "/Users/magaliblanco/Everything/School/PhD_UW/Courses/2. Winter 18/ENVH 595 Yost RR/Data/Dylos/Event Min Met/AAS9.csv", row.names=F)
...
#write.csv(AAS10, "/Users/magaliblanco/Everything/School/PhD_UW/Courses/2. Winter 18/ENVH 595 Yost RR/Data/Dylos/Event Min Met/AAS10.csv", row.names=F)
...
#write.csv(AAS11, "/Users/magaliblanco/Everything/School/PhD_UW/Courses/2. Winter 18/ENVH 595 Yost RR/Data/Dylos/Event Min Met/AAS11.csv", row.names=F)
...
#write.csv(AAS12, "/Users/magaliblanco/Everything/School/PhD_UW/Courses/2. Winter 18/ENVH 595 Yost RR/Data/Dylos/Event Min Met/AAS12.csv", row.names=F)
...
#write.csv(AAS13, "/Users/magaliblanco/Everything/School/PhD_UW/Courses/2. Winter 18/ENVH 595 Yost RR/Data/Dylos/Event Min Met/AAS13.csv", row.names=F)
...
#write.csv(AAS14, "/Users/magaliblanco/Everything/School/PhD_UW/Courses/2. Winter 18/ENVH 595 Yost RR/Data/Dylos/Event Min Met/AAS14.csv", row.names=F)
...
#write.csv(AAS15, "/Users/magaliblanco/Everything/School/PhD_UW/Courses/2. Winter 18/ENVH 595 Yost RR/Data/Dylos/Event Min Met/AAS15.csv", row.names=F)
